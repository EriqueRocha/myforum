...
//-----------------------------------------------------------------------------------------------------
    ...
    public static Object errorNotAcceptable(String message, String observation) {
        return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE).body(new Response<>(LocalDateTime.now(), false, message, 406, null, observation));
    }
    ...
    public static Object errorBadRequest(String message) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new Response<>(LocalDateTime.now(), false, message, 500, null, "entre em contato com o desenvolvedor"));
    }

    public static Object errorUnautorized(String message, String observation) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new Response<>(LocalDateTime.now(), false, message, 401, null, observation));
    }
